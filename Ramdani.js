...
module.exports = Ramdani = async (Ramdani, mek) => {
	try {
        ...
        const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = Ramdani.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "Pilih Disini","footerText": "© SC BY FDLMODS⸙","listType": "SINGLE_SELECT","sections": list}}, {})
     ...
     const time2 = moment().tz('Asia/Jakarta').format('HH:mm:ss')
       ...
       console.error(err)
        ...
        const ftoko = {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: {"productMessage": {"product": {"productImage":{"mimetype": "image/jpeg","jpegThumbnail": fs.readFileSync(`./media/Ramdani3.jpg`)},"title": `© SC BY FDLMODS⸙`,"description": "Ramdani Official", "currencyCode": "IDR","priceAmount1000": "999999","retailerId": "Ramdani Official","productImageCount": 1},"businessOwnerJid": `0@s.whatsapp.net`}}}
      ...
      mentions(cptl, x, true)
       ...
       case 'donasi':
        ...
        case 'creator':
               ...
               buttons = [{buttonId: '!youtube',buttonText:{displayText: 'youtube'},type:1},{buttonId:'!infoig',buttonText:{displayText:'ıηsтαgяαм'},type:1}]
...
☢ Prefix : > multi prefix <
🔋 baterai bot : ${baterai}%
👨💻 Name Creator : FDLMODS


       『 USER INFO 』
       
🏅 Status : ${isOwner ? 'OWNER' : isPremium ? 'Premium' : 'Non-Prem'}
🎎 Nama : ${pushname}
🎿 Bio : [object Object]
...
break
      ...
      case 'toimg':
              ...
              Ramdani.sendMessage(from, buffer, image, {quoted: mek, caption: 'Nih banh'})
              fs.unlinkSync(ran)
})
              break
       case 'smeme': 
...
//------------------<18+ Menu>-----------------------   
       case 'randombokep':
              ...
              Ramdani.sendMessage(from, '*PERMINTAAN:* '+bokep+'\n*DOSA TANGGUNG PRIBADI*\n*NI BRO FREE BUAT KAMU DOWNLOAD SENDIRI:* '+ kep, text, { quoted: ftoko, caption: `NI BOKEP SAYA DAPAT DARI *© SC BY FDLMODS⸙* DOSA TANGGUNG SENDIRI🗿`})
              break
                case 'xnxx':
...
//------------------< Ingfo Bot >-------------------
      case 'runtime':
              ...
              break
       case 'youtube': 
              reply(`*Gabung Grup Bot :*\n https://chat.whatsapp.com/IPK8XvIFZfoBe0bnxGakDq`)
              break
case 'y':
reply ('Y')
break
...
//------------------< Lainnya >-------------------
        ...
        case 'infobot':  // Jangan Di Ubah Plise
               gopeynya = 'https://i.ibb.co/kynNYTh/Ramdani2.jpg'
               thankslort = `━━━━━ *INFO BOT* ━━━━━\n➤ *BOT INI MENGGUNAKAN SCRIPT BOT DARI FDLMODZZ, JIKA INGIN MENDAPATKAN SC INI, TEKAN LINK DI BAWAH INI!!!*\n➤ *LINK GRUP BIOT : https://chat.whatsapp.com/IPK8XvIFZfoBe0bnxGakDq*\n➤ *RUN BOT : TERMUX*\n➤ *TIPE : NODE JS*\n➤ *BASE : FDLMODZZ*\n*━━━━━━━━━━━━━━━━━━━━*`
...
case 'caripesan':  //by ANU TEAM
       ...
       case 'bugreport':
              ...
              Ramdani.sendMessage('6285157740529@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
              break
       case 'readall':
...
//------------------< Menunya Bang:v >-------------------
     case 'info bot':
     reply (`━━━━━ *INFO BOT* ━━━━━
❏ BOT INI GRATIS, JADI JANGAN DISALAH GUNAKAN. SC BY FDLMODS
❏ LINK Group TEST SC : https://chat.whatsapp.com/IPK8XvIFZfoBe0bnxGakDq
❏ RUN BOT : TERMUX
❏ TIPE SC : JSON
❏ BASE : FDLMODS
*━━━━━━━━━━━━━━━━━━━━*`)
...
└⬣`)
      ...
      case 'qris':      
        qris =`*FDLMODZZZ*`
               ...
               buttonsMessage = {
               contentText: `${qris}`,
               footerText: '© SC BY FDLMODS⸙', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
//payment                
      case 'dana':
             reply(`DANA : 089604092736`)
             break
           case 'gopay':
             reply(`*Goopay :* BELUM ADA`)
             break  
         case 'pulsa':
             reply(`*Pulsa :* 089604092736`)
             break              
      case 'infoig':
             reply(`Follow Instagram Owner Ya : https://www.instagram.com/fadhlurahmanfadhlurahman`)
             break
      case 'grupbot':
             reply('https://chat.whatsapp.com/IPK8XvIFZfoBe0bnxGakDq')
             break
//case menu
      case 'ownermenu':
...
break
  ...
  case 'allmenu':{
					if(MessageType == 'templateLocation'){
						...
						{
							"urlButton": {
								"displayText": "FOLLOW IG CREATOR",
								"url": `https://instagram.com/fadhlurahmanfadhlurahman`
								}
								},
								{
									"urlButton": {
						...
						if(typemenu == 'templateTenor'){
							...
							{
								"urlButton": {
									"displayText": "GRUP BOT FDLMODZZ",
									"url": `https://chat.whatsapp.com/IPK8XvIFZfoBe0bnxGakDq`
									}
								},
								{
									"urlButton": {
